...
| 03 | [Diorama](./demos/vignette) | A chip-based brief + library of agent-generated parts → 3 LLM-composed variants → an interactive 3D scene the user can swap & re-roll component-by-component | 🟢 working — library + variant picker + per-component swap, in-browser Anthropic |
