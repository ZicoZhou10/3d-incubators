...
| 02 | [Prompt-to-Object](./demos/prompt-to-object) | A text description → a single 3D object, generated by an agent through the Aholo MCP server | 🟡 generation pipeline verified end-to-end; viewer rendering blocked — see [KNOWN_ISSUE](./demos/prompt-to-object/KNOWN_ISSUE.md) |
